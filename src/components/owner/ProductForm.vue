      ...
      <div class="form-group">
        ...
        <select
          ...
          <template v-for="manufacturer in manufacturers">
            <option v-bind:key="manufacturer._id" :value="manufacturer._id" :selected="manufacturer._id == (model.manufacturer && model.manufacturer._id)">{{manufacturer.name}}</option>
          </template>
        </select>
    ...
    saveProduct () {
      this.$validator.validateAll().then(() => {
        ...
        this.$store.commit(ERROR_MSG, {
          ...
          content: 'Убедитесь в правильности ввода данных.'
        })
      })
    }
  }
